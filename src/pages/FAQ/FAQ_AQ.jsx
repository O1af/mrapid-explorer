...
function FAQ_AQ() {
    return (
        <section class="page-faq">
            ...
            <p><span style={"background-color:yellow"}>[PUT TABLE HERE SOMEWHERE]</span></p>
            <p>(Table from: https://caphedetroit.sph.umich.edu/wp-content/uploads/2016/10/Resource-Manual-3.0-Air-Quality-Health-Environmental-Justice-Website-Version-10-4-16.pdf)</p>
            <ul>
                <li>
            ...
            <p><span style={"background-color:yellow"}>[PUT TABLE IMAGE HERE SOMEWHERE]</span></p>
        </section>
    );
}
