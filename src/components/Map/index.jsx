...
export const parametersBins = {
  1: [0, 12.1, 35.5, 55.5, 150.5, 250.5], // PM1 count (particles/cm³) openAQ's
  2: [0, 55, 155, 255, 355, 425], // PM10 (µg/m³)
  3: [0, 12.1, 35.5, 55.5, 150.5, 250.5], // PM2.5 (µg/m³)
  4: [0, 0.036, 0.076, 0.186, 0.305, 0.605], // SO₂ (ppm)
  5: [0, 4.5, 9.5, 12.5, 15.5, 30.5], // CO (ppm)
  6: [0, 0.055, 0.071, 0.086, 0.106, 0.2], // O₃ mass (ppm)
  7: [0, 0.054, 0.101, 0.361, 0.65, 1.25], // NO₂ (ppm) 
  8: [0, 36, 76, 186, 305, 605], // SO₂ (ppb)
  9: [0, .0045, 0.0095, 0.0125, 0.0155, 0.0305], // NO mass (µg/m³) openAQ's
  10: [0, 0.5, 1, 2, 3, 4, 5], // NOx (ppm) openAQ's
  11: [0, 12.1, 35.5, 55.5, 150.5, 250.5], // BC (µg/m³) openAQ's
  12: [0, 12.1, 35.5, 55.5, 150.5, 250.5], // PM4 (µg/m³) * openAQ's
  13: [0, 400, 1000, 2000, 3000, 4000], // CO₂ (ppm) openAQ's 
  14: [0, 55, 71, 86, 106, 200], // O₃ (ppb)
  15: [0, 54, 101, 361, 650, 1250], // NO₂ (ppb)
  16: [0, 0.036, 0.076, 0.186, 0.305, 0.605], // SO₂ (ppm)
