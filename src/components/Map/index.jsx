...
export const parametersBins = {
  ...
  4: [0, 4500, 9500, 12500, 15500, 30500], // CO (ppb)
  5: [0, 36, 76, 186, 305, 605], // SO₂ (ppb)
  6: [0, 55, 71, 86, 106, 200], // O₃ (ppb)
  7: [0, 54, 101, 361, 650, 1250], // NO₂ (ppb)
  8: [0, 54, 101, 361, 650, 1250], // NOx (ppb)
  9: [0, 54, 101, 361, 650, 1250], // NO (ppb)
  10: [0, 1, 3, 7, 12, 16], // BC (µg/m³) kinda guessed on the maroon one since I only could find 1 source
  11: [0, 12.1, 35.5, 55.5, 150.5, 250.5], // PM4 (µg/m³) * openAQ's
  12: [0, 400000, 1000000, 2000000, 3000000, 4000000], // CO₂ (ppb) openAQ's 
